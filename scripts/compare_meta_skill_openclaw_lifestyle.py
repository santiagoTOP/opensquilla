...
DOCUMENT_DECISION_RUBRIC: tuple[RubricCriterion, ...] = (
    criterion(
        "bottom_line",
        "Gives a clear sign/negotiate/reject recommendation.",
        r"recommendation",
        r"建议",
        r"bottom[- ]line",
    ),
    criterion(
        "evidence_table",
        "Uses an evidence table or source-by-source facts.",
        r"evidence table",
        r"证据表",
        r"source",
        r"来源",
    ...
    criterion(
        "money_dates_obligations",
        "Extracts money, dates, penalties, renewal, or obligations.",
        r"18,?600",
        r"2026-06-0[23]",
        r"renew",
        r"续约",
    ...
    criterion(
        "risk_ranking", "Ranks risks by severity.", r"high", r"medium", r"low", r"高", r"中", r"低"
    ),
    criterion(
        "next_24h",
        "Provides actions for the next 24 hours.",
        r"24 hours",
        r"24 小时",
        r"next step",
        r"下一步",
    ...
    criterion(
        "professional_caveat",
        "Flags legal/accounting review instead of giving regulated advice.",
        r"lawyer",
        r"legal",
        r"律师",
        r"professional",
...
WEB_PARENT_ESIM_RUBRIC: tuple[RubricCriterion, ...] = (
    criterion(
        "decision_context",
        "States assumptions and the parent's travel context.",
        r"assumption",
        r"假设",
        r"decision context",
        r"爸妈",
    ...
    criterion(
        ...
        "Chooses eSIM, roaming, local SIM, or hybrid.",
        r"recommendation",
        r"建议",
        r"eSIM",
        r"roaming",
    ...
    criterion(
        "source_list",
        "Includes source list with URLs or source IDs.",
        r"https?://",
        r"\[S\d+\]",
        r"Sources",
        r"来源",
    ...
    criterion(
        "tradeoffs",
        "Compares activation, support, hotspot, refund, or phone compatibility.",
        r"activation",
        r"激活",
        r"hotspot",
        r"客服",
    ...
    criterion(
        "next_steps",
        "Provides purchase/setup/checklist steps.",
        r"next step",
        r"下一步",
        r"checklist",
        r"清单",
    ...
    criterion(
        "evidence_limits",
        "Separates current evidence limits from recommendations.",
        r"evidence limit",
        r"限制",
        r"unknown",
        r"无法确认",
...
DAILY_OPERATOR_RUBRIC: tuple[RubricCriterion, ...] = (
    criterion(
        "top_priorities",
        "Returns the top three priorities.",
        r"top 3",
        r"前三",
        r"priority",
        r"优先",
    ...
    criterion(
        "calendar_risks",
        "Calls out schedule conflicts or task risks.",
        r"risk",
        r"冲突",
        r"delay",
        r"延期",
    ...
    criterion(
        "weather_commute",
        "Accounts for weather or commute implications.",
        r"weather",
        r"天气",
        r"commute",
        r"通勤",
    ...
    criterion(
        "followups",
        "Names people/messages to follow up.",
        r"follow up",
        r"跟进",
        r"提醒",
        r"message",
...
COMPETITIVE_INTEL_RUBRIC: tuple[RubricCriterion, ...] = (
    criterion(
        "target_scope",
        "Names the monitored targets and requested dimensions.",
        r"ByteDance",
        r"小红书",
        r"账号",
        r"账户",
    ...
    criterion(
        "signal_table",
        "Creates a signal table or structured account-by-dimension list.",
        r"signal",
        r"信号",
        r"table",
        r"表",
    ...
    criterion(
        "baseline_diff",
        "Separates new/changed/unchanged signals against the pasted baseline.",
        r"new",
        r"changed",
        r"unchanged",
        r"新增",
    ...
    criterion(
        "strength_verdict",
        "Classifies signal strength or urgency.",
        r"URGENT",
        r"HIGH",
        r"MED",
        r"LOW",
    ...
    criterion(
        "next_actions",
        "Gives concrete sales/BD/competitive next actions.",
        r"next action",
        r"下一步",
        r"follow up",
        r"跟进",
    ...
    criterion(
        "source_limits",
        "Labels source limits and avoids inventing unsourced facts.",
        r"source",
        r"来源",
        r"unknown",
        r"未验证",
...
JOB_SEARCH_RUBRIC: tuple[RubricCriterion, ...] = (
    criterion(
        "role_company_fit",
        "Identifies the target role/company and fit thesis.",
    ...
    criterion(
        "tailored_resume",
        "Produces tailored resume bullets without inventing experience.",
        r"简历",
        r"resume",
        r"bullet",
        r"项目",
    ...
    criterion(
        "cover_letter",
        "Includes a concise cover letter or outreach note.",
        r"cover letter",
        r"求职信",
        r"邮件",
        r"outreach",
    ...
    criterion(
        "jd_gap_table",
        "Maps JD requirements to evidence and gaps.",
        r"JD",
        r"requirements",
        r"gap",
        r"差距",
    ...
    criterion(
        "interview_prep",
        "Adds interview prep or likely questions when useful.",
        r"interview",
        r"面试",
        r"question",
        r"准备",
    ...
    criterion(
        "truth_safety",
        "States no fabrication and marks unverifiable or missing facts.",
        r"do not invent",
        r"不编",
        r"未提供",
        r"unknown",
...
ENGLISH_LIFESTYLE_PROMPTS: dict[str, str] = {
    ...
    "job_search_tailor_pack": (
        ...
        "3 enterprise customers; used SQL for retention reporting; raised new-user guide "
        "completion from 52% to 68%; wrote 20+ help docs; recently joined an AI "
        "customer-service pilot but was not the owner. Please output resume-rewrite points, "
        "Chinese resume text "
        "I can paste, a cover "
